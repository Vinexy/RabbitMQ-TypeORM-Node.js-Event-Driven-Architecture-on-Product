...
data_source_1.AppDataSource.initialize().then(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        productRepository = data_source_1.AppDataSource.manager.getMongoRepository(product_1.Product);
        amqp.connect('amqps://fckobzcu:riQ_pSyoN-4fWQSwqslGt2afSmW6N20b@cow.rmq2.cloudamqp.com/fckobzcu', function (error0, connection) {
            if (error0) {
                throw error0;
            }
